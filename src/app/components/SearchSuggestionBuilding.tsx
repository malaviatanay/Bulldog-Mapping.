...
type BuildingType = Tables<"building">;

type SearchSuggestionBuildingProps = {
  building: BuildingType;
  onClick: () => void;
};

export default function SearchSuggestionBuilding({
  building,
  onClick,
}: SearchSuggestionBuildingProps) {
  const firstImage = building.image_URLs?.[0];
    ...
    >
      ...
      <div className="flex-1 min-w-0">
        ...
        <div className="flex items-center gap-2">
          <span className="button-depth inline-flex items-center px-2 py-0.5 rounded-md text-[10px] font-medium bg-blue-500 border-blue-600 text-white">
            Building
          </span>
